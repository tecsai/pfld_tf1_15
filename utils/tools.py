...
def point_img(img, landmarks, thrtas):
    w = img.shape[1]
    h = img.shape[0]
    # print("image width: ", w)
    # print("image height: ", h)
    # print("landmarks: ", landmarks.shape[1])
    # print("thrtas: ", thrtas.shape[1])
    """ landmarks """
    for i in range(int(landmarks.shape[1]/2)):
        cv2.circle(img, (int(landmarks[0][i*2+0]*w), int(landmarks[0][i*2+1]*h)), 2, (0, 0, 255), -1)
